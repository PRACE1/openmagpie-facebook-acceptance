...
## [0.9.0](https://github.com/PRACE1/openmagpie-facebook-acceptance/compare/v0.8.0...v0.9.0) (2026-09-04)
...
* **auth:** web auth UI + magpie CLI + device-flow handshake ([762f366](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/762f36601c7d55eedd67962d87816f5e759925c9))
* **auth:** web auth UI + magpie CLI + device-flow handshake ([c482818](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/c4828187319f2c08cca484dfbda0843310612f02))
...
* **cli:** magpie listener create + list + template ([16b531b](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/16b531b7e18fd1f9be6be791c619841a1332c416))
...
* **core:** linked-article enrichment via challenge-bypass sidecar, per-kind fetch target ([#171](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/171)) ([cd31f8f](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/cd31f8f3cd5dbf369ab01a43115f9ce88eafe1ce))
...
* **core:** plugins app, a registration + routing layer for forks & third-party plugins ([#169](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/169)) ([ec76be4](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/ec76be49655163fa7573fa5d1d4a629072366003))
...
* **engine:** per-listener model override + engine-owned validation ([cccc7f4](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/cccc7f451de2a013e835ae41b37b4696d9bbe888))
* **engine:** per-listener model override + Ollama availability check ([53d9ed1](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/53d9ed1df9125400feaab94298f6e66a487b7c7f))
...
* **facebook:** strict Pydantic validation, failure-path test, lefthook ([263e1b6](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/263e1b6c5469c4e1911b172c3be23ae6440d72cd))
...
* **feeds:** renewable poll lock lease so any feed size polls reliably ([6d828f2](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/6d828f2d502f4401cba1e9a3b97e0b735b9e70f0))
* **feeds:** renewable poll-lock lease so any feed size polls reliably ([71656a7](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/71656a797b97b422f8b581cb9dd4b9b2658a55fb))
...
* **judgment:** bounded retry on transient judge failures ([bfd1a8a](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/bfd1a8ae30a4d248f1ce79e167d8054c4a39ef1a))
* **judgment:** bounded retry on transient judge failures ([3399e97](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/3399e976cf4efd0a0ce5bd079b3c45eeb6e801d7))
* **links:** URL shortener with deduplicated click analytics ([#173](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/173)) ([3212e0e](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/3212e0e4b79590d266c95ba96dfc9b9b8bafa0f1))
...
* **listeners:** dry-run validate + confirm before create ([9de07c3](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/9de07c34a548d9936e83ddb080ec44bb021aa3d0))
* **listeners:** HTTP API for creating + listing listeners ([206c103](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/206c103d83fe51788f7dd8576204236fe493f0b1))
* **listeners:** HTTP API for creating + listing listeners ([96c96b5](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/96c96b5e9d5c89f1c76160b4f77198ff84c13cf5))
* **listeners:** log cold-start watermark init ([bbcd663](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/bbcd663c348ad37ee40297cd51bc4265a904877d))
...
* **listeners:** persist judge cursor incrementally ([cab62a7](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/cab62a79a2c0b9bb46a3e9fee1e84ff8f5eec70a))
* **listeners:** persist judge cursor incrementally, not just at end ([a349484](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/a34948462458355ba690e5fefa072bd3d1da9434))
* **listeners:** single-listener get / edit / delete (CRUD) ([cc71fd4](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/cc71fd488bc6c159f77be5706102001223438110))
* **listeners:** single-listener get / edit / delete (CRUD) ([be05108](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/be05108350cd01b9428ed8cb9a46435e9d88ce96))
* **marketing:** serve the curl|sh quickstart installer ([#74](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/74)) ([dfee118](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/dfee1180b5f69c96a8a9737a053dfed07776ab9f))
* move to Postgres (multi-writer pipeline needs MVCC) ([f4c7775](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/f4c7775b785a1b1f6223599103f14abfbd557e77))
* move to Postgres (multi-writer pipeline needs MVCC) ([2d25380](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/2d253808c5a97f753fc9fea7ef6869e6db078114))
...
* openmagpie v0 — event-sourced semantic listener ([fc1db1b](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/fc1db1b0b529cd758662f69a9dedda0195e29a5c))
* openmagpie v0 — event-sourced semantic listener (engine layer) ([a098179](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/a09817986610b9321c4eb42159bcc2f7b642c514))
...
* production-deployable images (gunicorn + email-render Dockerfile + GHCR CI) ([#58](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/58)) ([3e2b815](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/3e2b81525e9f98bb28706d292d7e5b368f3a56b8))
* **quickstart:** diagnose LLM probe failures + harden uv preflight ([#92](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/92)) ([ef600a0](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/ef600a0bcc51941c2dc7347f53414f28ca6e795a))
* **quickstart:** personalized, editable quickstart seed ([#94](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/94)) ([4695aca](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/4695aca4330ca0df46154aee5c93445556b95ec7))
* **quickstart:** pin curl|sh install to the latest release tag ([#100](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/100)) ([ed13302](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/ed133026405ddc00c04ca18ac3dbe826ed19dbf2))
...
* **schema:** webhook payload contract, HTTP method, delivery wire ([6146d7e](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/6146d7ecefeb6ad66b41824b113cf03fdddac82d))
* **scripts:** make-free quickstart installer + friendly Docker preflight ([#73](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/73)) ([9a60544](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/9a6054417b624ce42b1071f5194d23b55fbe6c77))
* **settings:** cloud settings module + cloud/local env naming ([#57](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/57)) ([e3b796a](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/e3b796a802aa7f5679ae5b70465bba12f1803048))
* **sources:** add twitter_search connector (twikit-based) with schema parity ([1dcf731](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/1dcf7317e55ca1c877aac320ec112bf4a14e97ef))
...
* **sources:** generic RSS / Atom connector ([463f429](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/463f42971bff87fa34bc2481b7e84ed83decb540))
* **sources:** generic RSS / Atom connector behind `kind: rss` ([b6130a6](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/b6130a656b99a146062864302d11ed64dceb73d7))
* **sources:** log when a rate-limited page succeeds after retrying ([#93](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/93)) ([d982b90](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/d982b903607b3c2efddd38769236afcc0f30aecf))
...
* transactional email queue + render sidecar (waitlist welcome) ([#56](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/56)) ([f9b9f80](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/f9b9f80c0febdfaa3153733bb7bc4ae5e0d531d5))
...
* **v2:** digest delivery — fixed-window batched webhook/log ([b6bb208](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/b6bb2084a64434220d086d1ac1bc1e29e76fc016))
...
* **v2:** Watch / WatchPath / WatchAction / WatchActionRun / WatchFeed models ([37eaece](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/37eaece736b74868c931e8c3f373f1aa5cdb23d0))
* **v2:** Watch + WatchPath + WatchAction + WatchActionRun + WatchFeed models ([66e1cc9](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/66e1cc9614bfd8c5204e0a4b9000a9d092a84183))
...
* **v2:** watches actually run — action execution + trigger/drain crons ([91f6f65](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/91f6f65e2b9d554cc67002082dc9022b633558de))
* **v2:** watches actually run — action execution + trigger/drain crons ([b1c480b](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/b1c480b94cf28cf3adc60e45b7771fd19f85cb7a))
* **v2:** watches digest delivery ([763a3c4](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/763a3c4e0de2913d46608566ba97a0e171756406))
...
* waitlist signup (backend + marketing form + shared toast) ([#55](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/55)) ([a0591f3](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/a0591f35713357e4439a961a8512e3cfd40d9118))
* **waitlist:** capture which offering a signup is waiting for ([#63](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/63)) ([a6bb0dd](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/a6bb0dd771595faeb04887a32ada0d00756a4eed))
* **waitlist:** most-wanted-source vote (multi-select) on the confirm card ([#65](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/65)) ([f414994](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/f4149947c9c957e135bfdb14e7f277290e430ad3))
...
* **watches:** concurrent drain + engine rate-limit backoff + graceful job shutdown ([#172](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/172)) ([ac421c6](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/ac421c62d60f15790bcf49fab510e536e4f74785))
* **watches:** drain emits periodic per-action progress logs ([36ae0fb](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/36ae0fb244ad009cb0e70953703dfa3a90943d72))
* **watches:** drain emits periodic per-action progress logs ([9f51ea7](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/9f51ea7c62b233cd4622141904b514e7af14cfdc))
* **watches:** lead drain line with progress, add action id ([7e5e946](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/7e5e94659f57492a6afd4d0914be19d1e35649ca))
...
* **watches:** per-run progress + ETA on the drain pass ([3a03b87](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/3a03b87a88e07578bd20e23ad9d5b2fc8a1cd894))
* **watches:** record + dedup webhook deliveries ([151bb5c](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/151bb5c7018801b4c1c082b42a9186d2a12c8ee2))
* **watches:** unified enriched webhook payload + PUT/PATCH ([5056138](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/50561384d7eff24f0d99b791fab0d416070ad95a))
* **watches:** WatchActionDelivery model + run.delivery_id ([4138dc1](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/4138dc18b4abb2bd73bf54bad106771235cd0042))
* **web:** blog at /blog, shared cross-origin theme, bundled brand assets ([#157](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/157)) ([e10a3c4](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/e10a3c4d7bc3afb0583429ef2350cfa2761eb8fe))
* **web:** marketing landing site (apps/marketing) ([#54](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/54)) ([9d3f100](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/9d3f10099a5008aa46e13c91066e1a6712c3ed91))


### 🐛 Bug Fixes

* **cli:** clear the 2 ty diagnostics ([8cbdeac](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/8cbdeacfdec69788cc0abb4424ac1b1344e7a413))
...
* **cli:** fail fast on unmodified template across all input modes ([82fa11c](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/82fa11ce49993c3bc079065da9027458915c8d81))
* **cli:** fail fast on unmodified template across all input modes ([375795b](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/375795b601f7bb46c187ad17a639a37b0ad1ce24))
...
* **cli:** surface a possibly-created id on unexpected responses ([d824015](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/d824015688d16876b27cec75fc448f6ab0e309b0))
* **cli:** treat missing id as failed persistence, not a '?' success ([4a6650b](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/4a6650b429b5ecd6d81cb32bfb7173a2e014c544))
...
* **common:** release job locks on SIGTERM + add clear_job_locks ([#72](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/72)) ([ac5fc56](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/ac5fc56024e7b5704f05b6a19299c4dc4e1983d1))
* **core:** own the venv as the non-root user so dev sync works ([#59](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/59)) ([0400a1c](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/0400a1ce44afbb11a999467bb6e5274b3048c817))
* **facebook:** add urlparse import, validate URL scheme and domain ([c8ee87c](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/c8ee87c585c3dac0308b2a3a4b83638c80486153))
* **facebook:** mypy compliance, ruff SIM103, cast imports ([e560977](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/e560977f2497e017822d5d0520f21a0fc3d1cb76))
* **feeds:** add missing migration for FeedItem.data help_text ([61663ca](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/61663ca366068cb8270f14d08bb32e4693495a69))
* **feeds:** address post-merge review of the quickstart seed ([#69](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/69)) ([#71](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/71)) ([f929967](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/f9299676fba37029f8c57b6b41e2c76ce2fd026d))
...
* **feeds:** poll sources in random order, streamed ([3dcba3c](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/3dcba3c83141ad85955e08796515ef9b223cf74e))
* **feeds:** poll sources in random order, streamed ([8dded5a](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/8dded5ad5bca5fd68f68b9a64266338604a4ffae))
* **listeners:** list endpoint robustness (review H1, H2) ([3673f89](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/3673f89c12ab3fd5b83478524ed89f47b9a9eeb3))
* **listeners:** notifier secret round-trip — kind-filtered pairing + fail-loud ([ef8b8f3](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/ef8b8f32638c134328a6ecda696d47c8957f890b))
* **listeners:** resolve code-review blockers (C1/C3/H3/C2) ([87aadc3](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/87aadc3c1bc399dce1efc8a262645b035a2fad98))
* **listeners:** second-review fixes + response DTOs + template file ([71b991d](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/71b991dcbd9de671fa7303747630c12c2e50e62c))
* **quickstart:** default the seed backfill to 1 day ([#90](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/90)) ([0360ce5](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/0360ce5b86fe39e13773851bb5cc640a83142492))
* **quickstart:** fresh-DB up --wait deadlock + one-command quickstart hardening ([#75](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/75)) ([305b4a6](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/305b4a644bc80c6e86f71db6b92c5ccf0886688a))
* **quickstart:** shellcheck source=/dev/null so pre-commit passes on single-file edits ([4dc37e7](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/4dc37e730f07d0bff026788adf2831196f6a8c5e))
* **quickstart:** silent preflight probe for ghcr.io registry access ([#88](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/88)) ([7dd3f74](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/7dd3f74c4b8362504a186806bd8414544f647eb1))
* **quickstart:** skip Git LFS smudge on the bootstrap clone ([#96](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/96)) ([25b4019](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/25b4019dfefcb396adc33afa3ad52c6041933c5d))
* **quickstart:** tell the user which LLM situation they are in at the engine prompt ([#89](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/89)) ([8093171](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/8093171de5e6151ca936db54f076fd873eeff04f))
* **reddit:** re-indent page-handling block inside pagination loop ([9fe47c2](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/9fe47c2fd95f57da5e7bffa78d9958a38458b875))
* **reddit:** re-indent page-handling block inside the pagination loop ([b2d4619](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/b2d46193d075aed65207cfb4a1cadc2e097fd4e4))
* **reddit:** swap anonymous .json for .rss Atom endpoint ([913195a](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/913195a3e43b2feb2d0e2096fd84e83fa9b3f25a))
* **reddit:** swap anonymous .json for .rss Atom endpoint ([9ded590](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/9ded590c15b03d1c90466c6dc669ef6951f6d084))
* **rss,reddit:** drop the bozo half of the parse gate ; it over- ([92168c3](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/92168c30dc6eb123e4d70fdd6290cc9eea5b4be8))
* **rss,reddit:** raise on 200-with-HTML rate-limit / block pages ([b444d1b](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/b444d1bd782434caaf2e6d42fbd748eda3c3ab8e))
* **rss:** SSRF guard at source create + connector ; stream body ([25ce480](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/25ce48063c7359d1f9d293cdbdbf1f6f739a4a8b))
* **rss:** unwrap Chromium XML-viewer body from challenge bypass ([d61a098](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/d61a098a0770b991a4ee7ed3a122ceff900f0a69))
* **rss:** unwrap Chromium XML-viewer body from challenge bypass ([baf0085](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/baf00858718c23d906de969771e07a9ac3298653))
* **sources/twitter:** per-call twikit client + retryable empty-404 mapping ([e611a6c](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/e611a6cc8d9c72329db1986fc95a7f7fa2d83d9d))
* **sources:** back off Reddit 429s; fail sources honestly on connector errors ([#87](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/87)) ([f8043dd](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/f8043ddaff94b6ac3cf69a13298c947c5b3ea977))
* **sources:** flip watermark gate to strict `<` ; factor streamed- ([c9e1f47](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/c9e1f472dbca9f42b7a297b41400bc8d8d00d822))
* **sources:** honor Reddit's x-ratelimit-reset for 429 backoff ([#128](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/128)) ([60d54cb](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/60d54cb759bc8dab4b1123980868c5a4841d0b92))
...
* **reddit:** batch a feed's subreddit sources into one multireddit fetch ([#126](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/126)) ([5c8e811](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/5c8e811d6f87022afe840918154c566fb75f00bf))


### 📝 Documentation

* add an LLM-assisted setup path (copy-paste prompt + quickstart pointer) ([#120](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/120)) ([61f8627](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/61f86275d384b0f772483d0a4816c591f8a58ff9))
* add community-health files for launch ([#66](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/66)) ([f1f918c](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/f1f918c3a77029c611dab5b5451e63684ed347ce))
* **cli:** codify typed-boundary convention in AGENTS.md ([ee2a77a](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/ee2a77a797c2a57a0ed7b7a1503a37b86c524d8b))
* codify changelog conventions + forbid -- as an em-dash stand-in ([#142](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/142)) ([21db051](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/21db05150941302e8fe3e1e6452d378a49c4d75d))
* date the changelog Unreleased section ([dadb71d](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/dadb71d36ea57ff318b62f6829038653ab4ff79a))
* date the changelog's Unreleased section ([e3d43d0](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/e3d43d0608aebf837a6e4fd0ff3093981464ebec))
* **demo:** add a Reddit-focused CLI tour GIF ([#111](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/111)) ([bcaefff](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/bcaefff35bdf6c0653c6ae0335c0236b29003b47))
* **quickstart:** note the CLI install in bootstrap.sh's run.sh handoff comment ([040204a](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/040204a0678f2e826b1ea33accbf8f357e49dc77))
* **quickstart:** point the README at `make up-jobs` after install ([#97](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/97)) ([ce90726](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/ce90726e5535477d09ab873e3492656a0c440e3d))
* **quickstart:** re-record quickstart GIF for the personalized seed, store GIFs in LFS ([#95](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/95)) ([3752712](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/3752712aa5c18f639fa9bde0a29161b0900d4b88))
* README slimmed into a 'Use it' flow with a header links row and a hosted-version waitlist callout; new make/README.md (curated dev commands, defers to make help); CHANGELOG. ([305b4a6](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/305b4a644bc80c6e86f71db6b92c5ccf0886688a))
* **readme:** be explicit about BYO Ollama ([2fc9bd5](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/2fc9bd514da457019c6227ee05f01c72e3438dcd))
* **readme:** be explicit about BYO Ollama ([9aaca24](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/9aaca2465fcb7939d0c213b3f02c2909bd5b69c1))
* **readme:** correct monorepo layout; refresh features for what actually shipped ([a36c188](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/a36c18830530b9d5a8ad8e91d5922c342fe46801))
* **readme:** correct monorepo layout; refresh features for what actually shipped ([2142e87](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/2142e87519a54b0bf26925810d904dd19fd8fc30))
...
* **readme:** pre-public fixes + document the background scheduler ([768bd00](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/768bd00d4c23659833bf7ca4a53250ab3c2b6da1))
...
* reposition README around community-engagement listening ([9e6d7af](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/9e6d7af7d6e98064dc5d5ca30b923c3f9f580828))
* rewrite README around social listening ([c1fbbe2](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/c1fbbe2da7d73fc74ce7c6f216f10627653f9cc4))
* simplify README tagline to 'Open-source social listening' ([#143](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/143)) ([68c2ae5](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/68c2ae5b67e93fccdd87558cbd5d76fafab7a765))
* **v2:** fix stale digest-head rule + trigger call-site in core AGENTS ([14266ba](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/14266ba26e8aa20ec9a22273e34467e32367057c))
...
* VHS-recorded install montage in the Quickstart, demo tooling ([#91](https://github.com/PRACE1/openmagpie-facebook-acceptance/issues/91)) ([febf431](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/febf431f6db0272ddb4330f0ac87db038118b3de))
* webhook payload schema + CHANGELOG ([c63189d](https://github.com/PRACE1/openmagpie-facebook-acceptance/commit/c63189d3dcb75258b879227d0713bf2c59b922b8))
